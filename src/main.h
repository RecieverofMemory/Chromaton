...
static const unsigned int MAX_BLOCK_SIZE = 30000;
/** Default for -blockmaxsize and -blockminsize, which control the range of sizes the mining code will create **/
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 25000;
static const unsigned int DEFAULT_BLOCK_MIN_SIZE = 0;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 30000;
/** The maximum size for transactions we're willing to relay/mine */
static const unsigned int MAX_STANDARD_TX_SIZE = 1500;
...
static const int COINBASE_MATURITY = 161280; //161280 is 40 weeks (human gestation).  based on 30MH/s network; it would take 6 months for 300H/s laptop to win a block.  Done to discourage pools and speculative mining.
